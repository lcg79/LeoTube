                                ...
                                <div class="container">
                                  <div class="row">
                                        ...
                                        <div class="data col-md-4">
                                            ...
                                            <p>Subido por <strong><a href="{{ route('channel', [ 'user_id' => $video->user->id ]) }}">{{ $video->user->name . ' ' . $video->user->surname  }}</a> hace {{ \FormatTime::LongTimeFilter($video->created_at) }}</strong> ({{$video->created_at}})</p>
                                        </div>
